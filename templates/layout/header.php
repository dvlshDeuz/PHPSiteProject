...
<head>
    ...
    <link href="../../public/assets/css/form.min.css" rel="stylesheet">
...
<div class="wrapper flex flex-1 flex-col bg-gray-100">
    <header class="bg-white">
        <div class="border-b">
            <div class="container mx-auto block overflow-hidden px-4 sm:px-6 sm:flex sm:justify-between sm:items-center py-4 space-y-4 sm:space-y-0">
                <div class="flex justify-center">
                    <a href="/" class="w-36 items-center flex space-x-2" rel="nofollow" title="Сайт проекта">
                        <span class="font-bold" style="color: orangered">PhpProject</span>
                        <img src="/public/assets/images/deuz_logo.png" width="50" alt="Сайт проекта">
                    </a>
                </div>
                <div>
                        ...
                        <ul class="flex justify-center sm:justify-end items-center space-x-8 text-sm">
                            <li>
                                <div class="flex items-center space-x-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="inline-block text-red-600 h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <?php View::includeTemplate('blocks/menu.php', ['currentPage' => $currentPage ?? null, 'isAuthorized' => auth()->isAuthorized()]); ?>
    </header>
    <main class="flex-1 container mx-auto bg-white overflow-hidden px-4 sm:px-6">
        <div class="py-4 pb-8">
            <h1 class="text-black text-3xl font-bold mb-4"><?=htmlspecialchars($title)?></h1>

            <?php View::includeTemplate('blocks/messages/error_message.php', ['messages' => container()->get(FlashMessagesContract::class)->getErrors()]);?>
            <?php View::includeTemplate('blocks/messages/success_message.php', ['messages' => container()->get(FlashMessagesContract::class)->getSuccess()]);?>
